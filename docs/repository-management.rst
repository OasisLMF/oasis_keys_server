...
https://oasislmf.github.io/oasis\_keys\_server/.
...
After cloning the repository (see the GitHub instructions on repository
home page) and entering the repository folder you should install the
package requirements using
...
https://oasislmf.github.io/oasis\_keys\_server/ on a fresh build.
...
recommended). Now copy the files to the docs folder using

::

    cp -R _build/html/* .

Add and ``git`` commit the new files, and GitHub pages will
automatically publish the new documents to the documentation site
https://oasislmf.github.io/oasis\_keys\_server/.